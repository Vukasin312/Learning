...
public class TestClass
{
	...
	public static bool CheckInterval(Interval i, int d, int h, int m, bool sign, int hits, int total)
	{
		string s;
		char znak;
	...
	public static bool CheckIntervalEquality(Interval a, Interval b, bool expect, int type, int hits, int total)
	{
		bool equals = true;
		if (type == 1)
		{
		...
		if (equals == expect)
		{
			Console.WriteLine($"Matching! Score: {hits + 1} {total}");
			return true;
		}
		Console.WriteLine(
	...
	//public static bool CheckTimestamp(Timestamp t, int y, int mm, int d, int h, int m, Interval z, int hits,
	//		int total)
	//{
	//	String s;
	//	// Model Timestampovog toString-a
	//	s = string.Format("%4d-%02d-%02d %02d:%02d(UTC %s)", y, mm, d, h, m, z.Render()).ToString();

	//	if (s.Equals(t.Render()))
	//	{
	//		Console.WriteLine("Matching! Score: %d/%d \r\n", (hits + 1), (total));
	//		return true;
	//	}
	//	Console.WriteLine("Not Matching! (Timestamp: %s, Expected: %s) Score: %d/%d \r\n", t.toString(), s, (hits),
	//			(total));
	//	return false;
	//}

	//public static bool CheckTimestampEquality(Timestamp a, Timestamp b, bool expect, int type, int hits,
	//		int total)
	//{
	//	bool equals = true;
	//	if (type == 1)
	...
	public static void test()
	{
		...
		//		Console.WriteLine("Total score:" + correct_cnt + "/" + total_cnt);
		//		Console.WriteLine(
